...
export interface Theme {
  ...
  layout: {
     ...
     * 위젯 내용 폭의 하한.
     *
     * 폭이 레인 수만 따라가면 주제가 하나일 때 위젯이 입력줄보다 좁아집니다.
     * 실측으로 224px 대 289px — 같은 패널에 쌓인 카드 하나만 65px 들어가
     * 있으니 어긋나 보입니다.
     *
     * 그것만이면 보기 문제지만, 폭이 좁으면 기능도 같이 잃습니다. 레인이
     * 하나면 카드가 펼쳐질 옆자리가 없어서 잘린 제목을 호버해도 그대로고,
     * 대신 남은 시간과 마감 시각이 두 줄로 접히면서 카드가 세로로 자라
     * 24h·DUE 선을 넘습니다. 하한을 두고 레인이 그것을 채우게 하면 셋이
     * 한꺼번에 풀립니다.
     */
    minWidth: number;
    laneGap: number;
