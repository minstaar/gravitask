...
export interface Theme {
  ...
  layout: {
     ...
     *
     * 24H 라벨이 경계선 위 2.8~15px을 쓰므로 최소 15는 되어야 겹치지 않습니다.
     * 10px일 때는 라벨 위쪽 5px(높이의 40%)이 카드 뒤로 들어갔습니다. 카드
     * 채움이 반투명이라 평소엔 비쳐 보였지만, 그 카드에 마우스를 올리면 불투명
     * 판이 깔려 통째로 가려졌습니다.
     *
     * 위젯에서 세로 1px은 비쌉니다. 필요한 만큼만 씁니다.
     */
    queueTop: number;
    /**
